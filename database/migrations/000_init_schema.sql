...
-- ====================================================================
-- 表 3: message_process_log (消息处理记录表 - 基础版本)
-- ====================================================================
CREATE TABLE IF NOT EXISTS message_process_log (
    ...
    folder_name VARCHAR(255) NOT NULL COMMENT '提取的目录名',
